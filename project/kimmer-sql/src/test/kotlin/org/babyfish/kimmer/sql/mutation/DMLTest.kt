    ...
    fun testDelete() {
        sqlClient.createDelete(Book::class) {
            ...
            throwable(ExecutionException::class) {
                """Cannot execute SQL [
                    |sql: delete from BOOK as tb_1_ 
                    |inner join BOOK_STORE as tb_2_ on tb_1_.STORE_ID = tb_2_.ID where 
                    |tb_2_.NAME = $1, variables: [MANNING]]""".trimMargin()
            }
        }
    }
}
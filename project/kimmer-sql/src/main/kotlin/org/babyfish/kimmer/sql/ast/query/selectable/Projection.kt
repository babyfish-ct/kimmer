...
object ProjectionContext {
    ...
    infix fun <T: Any, X: Entity<*>> NonNullExpression<T>.then(
        other: NonNullJoinableTable<X, *>
    ): Projection2<T, X> =
        Projection2Impl(this as Selection<*>, other as Selection<*>)

    infix fun <T: Any, X: Entity<*>> NonNullExpression<T>.then(
        other: JoinableTable<X, *>
    ): Projection2<T, X?> =
        Projection2Impl(this as Selection<*>, other as Selection<*>)
    ...
    infix fun <T: Entity<ID>, ID: Comparable<ID>, X: Any> NonNullJoinableTable<T, ID>.then(
        other: NonNullExpression<X>
    ): Projection2<T, X> =
        Projection2Impl(this as Selection<*>, other as Selection<*>)
    ...
    infix fun <T: Entity<ID>, ID: Comparable<ID>, X: Entity<*>> NonNullJoinableTable<T, ID>.then(
        other: NonNullJoinableTable<X, *>
    ): Projection2<T, X> =
        Projection2Impl(this as Selection<*>, other as Selection<*>)
    ...
    infix fun <T: Entity<ID>, ID: Comparable<ID>, X: Any> JoinableTable<T, ID>.then(
        other: NonNullExpression<X>
    ): Projection2<T?, X> =
        Projection2Impl(this as Selection<*>, other as Selection<*>)
    ...
    infix fun <T: Entity<ID>, ID: Comparable<ID>, X: Entity<*>> JoinableTable<T, ID>.then(
        other: NonNullJoinableTable<X, *>
    ): Projection2<T?, X> =
        Projection2Impl(this as Selection<*>, other as Selection<*>)
...
interface Projection2<T1, T2>: Projection<Pair<T1, T2>> {
    ...
    infix fun <X: Entity<*>> then(other: NonNullJoinableTable<X, *>): Projection3<T1, T2, X>

    infix fun <X: Entity<*>> then(other: JoinableTable<X, *>): Projection3<T1, T2, X?>
}
...
interface Projection3<T1, T2, T3>: Projection<Triple<T1, T2, T3>> {
    ...
    infix fun <X: Entity<*>> then(other: NonNullJoinableTable<X, *>): Projection4<T1, T2, T3, X>

    infix fun <X: Entity<*>> then(other: JoinableTable<X, *>): Projection4<T1, T2, T3, X?>
}
...
interface Projection4<T1, T2, T3, T4>: Projection<Tuple4<T1, T2, T3, T4>> {
    ...
    infix fun <X: Entity<*>> then(other: NonNullJoinableTable<X, *>): Projection5<T1, T2, T3, T4, X>

    infix fun <X: Entity<*>> then(other: JoinableTable<X, *>): Projection5<T1, T2, T3, T4, X?>
}
...
interface Projection5<T1, T2, T3, T4, T5>: Projection<Tuple5<T1, T2, T3, T4, T5>> {
    ...
    infix fun <X: Entity<*>> then(other: NonNullJoinableTable<X, *>): Projection6<T1, T2, T3, T4, T5, X>

    infix fun <X: Entity<*>> then(other: JoinableTable<X, *>): Projection6<T1, T2, T3, T4, T5, X?>
}
...
interface Projection6<T1, T2, T3, T4, T5, T6>: Projection<Tuple6<T1, T2, T3, T4, T5, T6>> {
    ...
    infix fun <X: Entity<*>> then(other: NonNullJoinableTable<X, *>): Projection7<T1, T2, T3, T4, T5, T6, X>

    infix fun <X: Entity<*>> then(other: JoinableTable<X, *>): Projection7<T1, T2, T3, T4, T5, T6, X?>
}
...
interface Projection7<T1, T2, T3, T4, T5, T6, T7>: Projection<Tuple7<T1, T2, T3, T4, T5, T6, T7>> {
    ...
    infix fun <X: Entity<*>> then(other: NonNullJoinableTable<X, *>): Projection8<T1, T2, T3, T4, T5, T6, T7, X>

    infix fun <X: Entity<*>> then(other: JoinableTable<X, *>): Projection8<T1, T2, T3, T4, T5, T6, T7, X?>
}
...
interface Projection8<T1, T2, T3, T4, T5, T6, T7, T8>: Projection<Tuple8<T1, T2, T3, T4, T5, T6, T7, T8>> {
    ...
    infix fun <X: Entity<*>> then(other: NonNullJoinableTable<X, *>): Projection9<T1, T2, T3, T4, T5, T6, T7, T8, X>

    infix fun <X: Entity<*>> then(other: JoinableTable<X, *>): Projection9<T1, T2, T3, T4, T5, T6, T7, T8, X?>
}
